...
<div class="inner mt5 mb5"  >
	<div id="artnav" >
		...
		<span><a href="{ART_URL}">{lang index}</a>&nbsp;>&nbsp;{lang poll}</span>
		</div>
		...
		<div id="listmain" class="bd " >
			...
			{loopif $list $tempi}
				<li style="padding:5px 0 5px;">
					<p class="atitle"><strong><i style="font-style:italic">{$tempi.hits}</i>.&nbsp;<a href="{$tempi.mvcurl}" target="_blank">{$tempi.title}</a></strong><i class="idate">{$tempi.dateline|time}</i></p>
				</li>	
			{loopelse}			
